...
python train_3d.py  \
 ...
 --target_dir  /lcrc/project/SDR/pjiao/data/cnn_train/vx3d/velocityx.f32//orig_data/ \
  ...
  --entropy none --train yes  \
   --outputs_dir /lcrc/project/SDR/pjiao/data/cnn_train/vx3d/velocityx.f32/model_unet_no_penalty_orig/ \
   --model unet --batch_size 8  --bestpath /lcrc/project/ECP-EZ/jp/git/arcnn/test/weights/vx3d_miranda_unet_no_penalty_orig.pth \
   --num_train 1000 
